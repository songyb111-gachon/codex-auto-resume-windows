...
## 미출시 — 자기가 시작한 턴을 따라가고, 무엇을 했는지 보여 줍니다

아직 내보내지 않았습니다. 릴리스를 낼 때 이 절은 그 릴리스 자신의 제목을 버전 번호와 함께 달게
됩니다.

두 가지가 바뀌었고 나머지는 거기에서 따라옵니다. 엔진은 복구가 잘 되었는지를 대화 전체에서 찾지
않습니다. 자기가 보낸 이어서 하기가 시작한 Codex 턴을 정확히 따라가고, 결과는 그 턴에서만 읽습니다.
그리고 시작 메뉴에서 여는 창은 설정 페이지였지만, 이제 워처가 무엇을 보고 무엇을 했는지 보여 줍니다.
원래 있던 설정 옆에 개요, 대기 중, 기록, 통계, 진단이 함께 있습니다.
