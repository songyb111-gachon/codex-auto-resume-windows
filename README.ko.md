...
<img src="docs/images/status-light.gif" alt="카드 위에서 숨 쉬는 상태 불빛. 청록색 점이 4.4초에 걸쳐 제 색의 3분의 2 정도까지 어두워졌다가 돌아오고, 밝아질수록 점 아래에서 부드러운 빛이 번져 나왔다가 호흡의 바닥에서는 사라집니다" width="112">
...
<img src="docs/images/icon-motion.gif" alt="알림 영역 아이콘의 움직임을 아이콘 자신의 프레임으로 그린 모습(밝은 작업 표시줄). 왼쪽부터 감시 중(밝은 머리가 숨 쉰 뒤 가장 밝은 채로 고리의 흰 획을 따라 시계 방향으로 쓸고 갔다가 돌아옵니다), 복구 중(청록색 배지 아래에서 계속 나갔다 돌아옵니다), 확인 필요(주황색 배지와 함께 주황색으로 한 번 맥박친 뒤 멈춥니다), 일시 정지(회색 배지와 함께 회색으로 멈춰 있습니다)" width="288">
