...
MESSAGES = {
    "en": {
        ...
        "setup_unconfirmed": "Auto resume is set up, but the watcher could not be confirmed running. Open the settings window, or run `doctor`, to check.",
        "setup_autostart": "It will also start automatically when you sign in to Windows.",
        "setup_incomplete": "Setup did not finish: preparing the recovery state or switching recovery on failed. Run `doctor` to see why.",
        ...
        "toast_failed_body": "The attempt did not go through. Nothing more will be sent automatically for this task.",
    ...
    "ko": {
        ...
        "setup_unconfirmed": "자동 재개는 설정되었지만 워처가 실행 중인지 확인하지 못했습니다. 설정 창을 열거나 `doctor`를 실행해 확인하세요.",
        "setup_autostart": "Windows에 로그인할 때도 자동으로 시작됩니다.",
        "setup_incomplete": "설정을 끝내지 못했습니다. 복구 상태를 준비하거나 자동 복구를 켜는 단계가 실패했습니다. `doctor`를 실행해 이유를 확인하세요.",
        ...
        "toast_failed_body": "이번 시도는 전달되지 않았습니다. 이 작업에는 더 이상 자동으로 보내지 않습니다.",
