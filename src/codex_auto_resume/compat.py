...
# implemented; they are listed so v0.6.10 can offer them, and they stay `unsupported`.
CAPABILITIES = {
...
# `permits()` reads them for anything v0.6.10 offers beyond the conservative default.
