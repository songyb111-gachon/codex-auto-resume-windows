...
게시되었고 그 고정값도 커밋되었으므로 3단계에는 견줄 다이제스트가 있습니다. 준비 중인 이번 릴리스는
아직 게시되지 않았습니다. 게시되고 그 고정값이 커밋되기 전까지 3단계에는 그 압축 파일과 견줄 것이 없고,
그것은 아래의 [새 릴리스에는 한동안 고정값이 없습니다](#확인되지-않은-것)가 말하는 경우입니다.
