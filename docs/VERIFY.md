...
with. v0.6.4, the version being prepared, is not published yet: until it is and its pin is
committed, step 3 has nothing to compare its archive with, which is the case [a new release
has no pin for a while](#what-is-not-verified) describes.
