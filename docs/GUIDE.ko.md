...
- 내 PC도 어떤 버전에 대해 말할 수 있습니다.
  ...
  [CONTRIBUTING.ko.md](CONTRIBUTING.ko.md#호환성-보고서-보내기)에 있습니다. 관리자의 손 없이 보통 몇 분 안에
...
| 모양 | 테마(시스템 설정 따르기, 밝게, 어둡게), 패널의 Codex 안의 테마, 디자인(부드럽게, 부드럽게, 움직임 없이, 클래식 (v0.6.2), 단순하게), 움직임 줄이기 |
