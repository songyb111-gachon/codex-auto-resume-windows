...
- 내 PC도 어떤 버전에 대해 말할 수 있습니다.
  ...
  식별자도 넣지 않으며, 보내기 전에 내가 먼저 읽습니다. 다른 사람이 보낸 보고서는 이 프로젝트의 근거와
  따로 보관되고, 자기 등급인 *보고됨*을 가집니다. 보고됨은 그 낱말들 옆에 서고, 어떤 경우에도 그중 하나가
  되지 않습니다. 보낸 사람의 컴퓨터에서 손으로 지어내지 않았다는 것을 증명할 방법이 없기 때문에, 보고는
  버전을 사다리 위로 올리지 못합니다. 대신 버전 옆에 자기 등급으로, 같은 말을 한 컴퓨터가 몇 대인지와 함께
  놓입니다. N대가 동작을, M대가 실패를, K대가 어느 쪽도 보이지 않음을 보고했다는 식입니다. 그 버전의 자체
  근거가 아무 말도 하지 않으면, 보고가 몇 건 오든 *호환됨*으로 남습니다. 그것들을 버전 옆에 보여 주는
  일은 이번 릴리스에서 합니다.
