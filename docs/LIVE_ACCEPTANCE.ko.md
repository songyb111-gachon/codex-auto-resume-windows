...
이번 릴리스라면 게시된 v0.6.4 설치본에서 시작해 그 위에 이번 압축 파일을 설치합니다. 이번 릴리스는
있던 설정을 하나도 바꾸지 않고, **알림 영역 옆에 알림을 카드로 표시** 설정 하나를 더하며, 그 설정은
업그레이드 뒤에 켜져 있습니다. 뒤에 설정을 읽어 보세요. **화면 언어**, **테마**, **메시지 스타일**, 직접
