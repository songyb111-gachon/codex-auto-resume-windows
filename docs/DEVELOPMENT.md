...
[FEATURE_MATRIX.md](FEATURE_MATRIX.md)에 적혀 있고, 그중 실제 기계 앞의 사람만 매듭지을 수 있는 부분은
[LIVE_ACCEPTANCE.md](LIVE_ACCEPTANCE.md)의 절차입니다.
...
[`../CONTRIBUTORS.ko.md`](CONTRIBUTORS.md)를 참고하세요. OpenAI Codex와 Anthropic Claude Code는 AI 개발
