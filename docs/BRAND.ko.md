...
| `STATUS_DOT`, `STATUS_FILL`, `GLOW` | 점 반경: 창 5, 팝업 4.5, 패널 6; 한 주기는 어두워짐 25%, 밝아짐 40%, 번짐 20%, 거둠 15%; 점은 바탕 쪽으로 38%까지 흐려짐; 빛은 점 바깥으로 3까지, 불투명도 0.30 | 상태 불빛: 그 크기, 상태마다의 색, 깜빡임, 그리고 빛. |
...
1. **어두워짐**, 주기의 4분의 1: 점이 제 색에서 놓인 바탕 쪽으로 38%까지 흐려집니다. 번지는 것은
   없습니다. (16픽셀인 아이콘의 머리는 더 깊이, 60%까지 흐려집니다.)
2. **밝아짐**, 40%: 점이 제 색으로 돌아옵니다. 여전히 번지는 것은 없습니다.
3. **번짐**, 20%: 다 켜진 점에서 빛이 없던 데서부터 불투명도 0.30까지, 점 가장자리 바깥 3픽셀까지
   번집니다.
...
빛은 원판이 아니라 흐려지는 빛입니다. 가장 밝을 때 알파는 점 가장자리에서 0.30 곱하기 0.67, 닿는 거리의
