...
함께 [README](https://github.com/songyb111-gachon/codex-auto-resume-windows/blob/main/README.md#먼저-읽어야-할-제한-사항)에 정리되어 있습니다.
...
허용하기 전에, [docs/VERIFY.md](VERIFY.md)("릴리스 검증하기")에 적힌 대로 압축 파일부터
확인하세요.
...
꾸미거나 진짜 워처를 멈출 수 있기 때문입니다. 이 거부는 v0.6.0부터입니다. 로그아웃했다가 다시 로그인하면 세션의 모든 프로그램이 끝나므로 이 상태도 풀립니다. 다시
