...
- **공개된 가장 새 릴리스는 v0.6.3입니다.** 아래에서 PUBLISHED라고 적힌 항목들이 뜻하는 것은
  공개된 릴리스, 곧 v0.6.0, v0.6.1, v0.6.2, v0.6.3입니다. 넷 다 압축 파일이 발행되었고 해시가
  `main`에 고정되어 있습니다. v0.6.3은 화면 언어 아홉 개, 이어가기 메시지 설정, 알림 영역 아이콘의
