...
이 문서의 그림은 합성 기록을 넣은 임시 설치에서 밝은 테마로 찍은 것입니다. 창이 어떻게 보이는지를 보여 줄 뿐
...
- 앞으로 릴리스마다 나아갈 방향(약속이 아니라 계획): [docs/ROADMAP.md](https://github.com/songyb111-gachon/codex-auto-resume-windows/blob/main/docs/ROADMAP.ko.md)
